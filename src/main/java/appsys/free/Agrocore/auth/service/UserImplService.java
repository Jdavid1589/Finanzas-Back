...
import appsys.free.Agrocore.auth.entity.*;
import appsys.free.Agrocore.auth.repository.UserRepository;
...
public class UserImplService implements UserDetailsService, IUserService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        if (userApp == null) {
            // ← CAMBIO: lanza excepción en vez de solo loguear
            logger.error("No existe usuario en el sistema: {}", userName);
        ...
        return new User(userName, userApp.getPassw(), userApp.isEnable(),
